...
# **تأكد أن هذه القيم صحيحة من my.telegram.org**    تيتو 
api_id = 25202058
...
BOT_TOKEN = '7809559614:AAF5SFPeQKZ-R7f_Gv8Z6CrZhJSg2fncsqs' # تأكد أن هذا التوكن هو بتاعك

# معلومات المطور والقناة (للاستخدام في الخاص فقط)
DEV_USERNAME = "developer: @Mo_sc_ow"  
CHANNEL_LINK_DISPLAY_TEXT = "Moscow" # النص اللي هيظهر للينك
...
# أمر "موسكو" لبدء التصفية (الرد الوحيد في المجموعة و سيتم حذفه فوراً)
